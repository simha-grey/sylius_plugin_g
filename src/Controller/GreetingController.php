...
final class GreetingController extends AbstractController
{
    ...
    {
        return $this->render('@RomaSyliusProductVariantPlugin/static_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }

    public function dynamicallyGreetAction(?string $name): Response
    {
        return $this->render('@RomaSyliusProductVariantPlugin/dynamic_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
